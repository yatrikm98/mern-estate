...
const navigate=useNavigate()
    ...
    const handleChange = (e) => {
        ...
        if (e.target.type === 'number' || e.target.type === 'text' || e.target.tagName.toLowerCase() === 'textarea') {
                ...
                <div className="flex flex-col gap-4 flex-1">
                    ...
                    <div className="flex flex-wrap gap-6 ">
                        <div className="flex items-center gap-2">
                            <input
                                className="p-3 border border-gray-300 rounded-lg bg-white" type="number" id="bedrooms" min='1' max='10'
                                required
                                onChange={handleChange}
                        ...
                        <div className="flex items-center gap-2">
                            <input
                                className="p-3 border border-gray-300 rounded-lg bg-white" type="number" id="bathrooms" min='1' max='10'
                                required
                                onChange={handleChange}
