const About = () => {
    return (
        <div className="py-20 px-4 max-w-6xl mx-auto">
            ...
            <p className="mb-4 text-slate-700">Sahand Estate is a leading real estate agency that specializes in helping clients buy,
            ...
            <p className="mb-4 text-slate-700">Our mission is to help our clients achieve their real estate goals by providing expert advice,
                ...
                sell, or rent a property, we are here to help you every step of the way.</p>
            <p className="mb-4 text-slate-700">Our team of agents has a wealth of experience and knowledge in the real estate industry,
                ...
                that buying or selling a property should be an exciting and rewarding experience, and we are
                dedicated to making that a reality for each and every one of our clients.</p>
        </div>
    )
}
